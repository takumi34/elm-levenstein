...
var $author$project$App$init = A3($author$project$App$Model, '', '', 0);
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('element')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('box1')
							]),
						_List_fromArray(
							[
								A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('box2')
							]),
						_List_fromArray(
							[
								A2(
